...
public class Test_TommyHilfigerEx {
    ...
    void beforeClass(){
        ...
        //driver.navigate().to("https://www.instagram.com/tommyhilfiger/?hl=en");
    ...
    public void Test_01_Instagram() throws InterruptedException, IOException {
        ...
        BaseTest baseTest = new BaseTest(driver);
        baseTest.GetDateFromFotos_37rows_WithNewLikes("https://www.instagram.com/tommyhilfiger/?hl=en", "TommyHilfigerEx");
        ...
        for(int i = 0; i < images.size(); i++) {
            ...
            if(count > 0){
                ...
                File file1 = new File("C:\\demo\\TommyHilfiger.xls");
                //File file1 = baseTest.FileUrl("TommyHilfiger");
            ...
            File file = new File("C:\\demo\\TommyHilfiger.xls");
            //File file = baseTest.FileUrl("TommyHilfiger");
