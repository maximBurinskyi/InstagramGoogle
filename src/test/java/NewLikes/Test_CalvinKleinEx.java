...
public class Test_CalvinKleinEx {
    ...
    void beforeClass() {
        ...
        //driver.navigate().to("https://www.instagram.com/calvinklein/?hl=en");
    ...
    public void Test_01_Instagram() throws InterruptedException, IOException {
        ...
        baseTest.GetDateFromFotos_37rows_WithNewLikes("https://www.instagram.com/calvinklein/?hl=en", "CalvinKleinEx");
        /*
        ...
        for(int i = 0; i < images.size(); i++) {
            ...
            if(count > 0){
                ...
                File file1 = new File("C:\\demo\\CalvinKlein.xls");
            ...
            File file = new File("C:\\demo\\CalvinKlein.xls");//E:/demo/employee2.xls
