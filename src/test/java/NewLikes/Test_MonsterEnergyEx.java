...
public class Test_MonsterEnergyEx {
    ...
    void beforeClass() {
        ...
        //driver.navigate().to("https://www.instagram.com/monsterenergy/?hl=en");
    ...
    public void Test_01_Instagram() throws InterruptedException, IOException {
        ...
        BaseTest baseTest = new BaseTest(driver);
        baseTest.GetDateFromFotos_37rows_WithNewLikes("https://www.instagram.com/monsterenergy/?hl=en", "MonsterEnergyEx");
        ...
        for (int i = 0; i < images.size(); i++) {
            ...
            if (count > 0) {
                ...
                File file1 = new File("C:\\demo\\MonsterEnergyEx.xls");
            ...
            File file = new File("C:\\demo\\MonsterEnergyEx.xls");//E:/demo/employee2.xls
