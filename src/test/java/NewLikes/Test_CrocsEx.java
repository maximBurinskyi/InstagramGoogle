...
public class Test_CrocsEx {
    ...
    public void Test_01_Instagram() throws InterruptedException, IOException {
        ...
        baseTest.GetDateFromFotos_37rows_WithNewLikes("https://www.instagram.com/crocs/?hl=en", "CrocsEx");
        /*

        driver.navigate().to("https://www.instagram.com/crocs/?hl=en");
        ...
        for(int i = 0; i < images.size(); i++) {
            ...
            if(count > 0){
                ...
                File file1 = new File("E:\\demo\\Сrocs.xls");
            ...
            File file = new File("E:\\demo\\Сrocs.xls");//E:/demo/employee2.xls
