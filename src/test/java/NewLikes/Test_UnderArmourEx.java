...
public class Test_UnderArmourEx {
    ...
    public void Test_01_Instagram() throws InterruptedException, IOException {
        ...
        BaseTest baseTest = new BaseTest(driver);
        baseTest.GetDateFromFotos_37rows_WithNewLikes("https://www.instagram.com/underarmour/?hl=en", "UnderArmourEx");
    ...
    public void Test_02_Instagram() throws InterruptedException, IOException {
        ...
        for (int i = 0; i < images.size(); i++) {
            ...
            if (count > 0) {
                ...
                File file1 = new File("C:\\Users\\Максим\\Desktop\\Insta output\\UnderArmourEx.xls");
            ...
            File file = new File("C:\\Users\\Максим\\Desktop\\Insta output\\UnderArmourEx.xls");//E:/demo/employee2.xls
            //file.getParentFile().mkdirs();
