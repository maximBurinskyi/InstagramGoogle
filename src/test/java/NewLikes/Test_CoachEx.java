...
public class Test_CoachEx {
    ...
    void beforeClass(){
        ...
        //driver.navigate().to("https://www.instagram.com/coach/?hl=en");
    ...
    public void Test_01_Instagram() throws InterruptedException, IOException {
        ...
        baseTest.GetDateFromFotos_37rows_WithNewLikes("https://www.instagram.com/coach/?hl=en", "CoachEx");
        ...
        for(int i = 0; i < images.size(); i++) {
            ...
            if(count > 0){
                ...
                File file1 = new File("C:\\demo\\Coach.xls");
            ...
            File file = new File("C:\\demo\\Coach.xls");//E:/demo/employee2.xls
