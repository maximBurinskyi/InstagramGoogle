           ...
           public void GetDateFromFotos_37rows(String url, String fileName) throws IOException, InterruptedException {
               ...
               for (int i = 0; i < images.size(); i++) {
                   ...
                   if (count > 0) {
                       ...
                       File file1 = new File("C:\\Users\\Максим\\Desktop\\Insta output\\" + fileName + ".xls");
                   ...
                   File file = new File("C:\\Users\\Максим\\Desktop\\Insta output\\" + fileName + ".xls");//E:/demo/employee2.xls
               ...
               public void GetDateFromFotos_37rows_WithNewLikes(String url, String fileName) throws IOException, InterruptedException {
                   ...
                   Thread.sleep(2000);
                   //wait0.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("button[class='dCJp8 afkep xqRnw _0mzm']")));
                   ...
                   //driver.findElement(By.name("username")).sendKeys("+380970698133");
                   //driver.findElement(By.name("password")).sendKeys("Qwerty12");
                   //driver.findElement(By.cssSelector("div[class='                  Igw0E     IwRSH      eGOV_         _4EzTm                                                                                                              ']")).click();

                   //Thread.sleep(2500);
                   //if(driver.findElements(By.cssSelector("button[class='aOOlW   HoLwm ']")).size() != 0)
                   //{
                   ...
                   //wait0.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("a[class='_0ZPOP kIKUG  ']")));
                   ...
                   for(int i = 0; i < images.size(); i++) {
                       ...
                       if(driver.findElements(By.cssSelector("div[class='QhbhU']")).size() > 0 ){
                           Thread.sleep(3000);
                           driver.findElement(By.cssSelector("div[class='QhbhU']")).click();
                       }
                       //if(driver.findElements(By.cssSelector("svg[aria-label='Close']")).size() != 0){
