...
public class Test_YetiEx {
    ...
    void beforeClass() {
        ...
        //driver.navigate().to("https://www.instagram.com/yeti/?hl=en");
    ...
    public void Test_01_Instagram() throws InterruptedException, IOException {
        ...
        BaseTest baseTest = new BaseTest(driver);
        baseTest.GetDateFromFotos_37rows_WithNewLikes("https://www.instagram.com/yeti/?hl=en", "YetiEx");
        ...
        for (int i = 0; i < images.size(); i++) {
            ...
            if (driver.findElements(By.cssSelector("li[class='-V_eO']")).size() > 2) {
                like = driver.findElements(By.cssSelector("li[class='-V_eO']")).get(2);
                e = driver.findElements(By.cssSelector("li[class='-V_eO']")).get(3);
            } else {
                like = driver.findElement(By.cssSelector("li[class='-V_eO']"));

                e = driver.findElements(By.cssSelector("li[class='-V_eO']")).get(1);
            }

            String likes = null;
            //String likes = like.getText();
            ...
            if (count > 0) {
                ...
                File file1 = new File("C:\\demo\\YetiEx.xls");
            ...
            File file = new File("C:\\demo\\YetiEx.xls");//E:/demo/employee2.xls
    ...
    public void Test_02_Instagram() throws InterruptedException, IOException {
        ...
        for (int i = 0; i < images.size(); i++) {
            ...
            if (count > 0) {
                ...
                File file1 = new File("C:\\Users\\Максим\\Desktop\\Insta output\\YetiEx.xls");
            ...
            File file = new File("C:\\Users\\Максим\\Desktop\\Insta output\\YetiEx.xls");//E:/demo/employee2.xls
            //file.getParentFile().mkdirs();
