package API.GoogleTrendsTestsWork;
...
public class TestPVHCalvinKleinWorldwideex {
  String token = null;
  ...
  public void apiTest1() throws UnirestException, FileNotFoundException {
    ...
    //String postApi = "https://trends.google.com/trends/api/explore?hl=en-US&tz=-120&req=%7B%22comparisonItem%22:%5B%7B%22keyword%22:%22%2Fm%2F03p1tw4%22,%22geo%22:%22%22,%22time%22:%22today+5-y%22%7D%5D,%22category%22:0,%22property%22:%22%22%7D&tz=-120";
    String postApi = "https://trends.google.com/trends/api/explore?hl=en-US&tz=-120&req=%7B%22comparisonItem%22:%5B%7B%22keyword%22:%22%2Fm%2F02r33n4%22,%22geo%22:%22%22,%22time%22:%22today+5-y%22%7D%5D,%22category%22:0,%22property%22:%22%22%7D&tz=-120";
    ...
    Wiw7 request = g.fromJson(jsonString, Wiw7.class);

    for (Wiw7 wi : request.widgets) {
  ...
  public void apiTest2() throws UnirestException, IOException {
    ...
    Gson g = new Gson();
    Wi8 request = g.fromJson(jsonString, Wi8.class);

    List<String> valueAndTime = new ArrayList<>();
    List<String> justTime = new ArrayList<>();


    for (Wi8 wi2 : request.timelineData) {
...
//    }
   ...
   /* for (String data : valueAndTime) {
    ...
    File file = new File("C:/demo/PVHCalvinKleinWorldwide.xls");
