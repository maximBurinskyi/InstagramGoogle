...
import API.GoogleTrendsTests2.Wi6;
import API.GoogleTrendsTests2.Wiw5;
...
public class TestTapestryWorldwideex {
  String token = null;
...
//    }
   ...
   /* for (String data : valueAndTime) {
    ...
    File file = new File("C:/demo/TapestryWorldwide.xls");
