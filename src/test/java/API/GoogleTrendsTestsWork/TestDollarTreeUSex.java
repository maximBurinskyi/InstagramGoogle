...
public class TestDollarTreeUSex {
  String token = null;
  ...
  public void apiTest1() throws UnirestException, FileNotFoundException {
    ...
    String postApi = "https://trends.google.com/trends/api/explore?hl=en-US&tz=-120&req=%7B%22comparisonItem%22:%5B%7B%22keyword%22:%22%2Fm%2F040rs1%22,%22geo%22:%22US%22,%22time%22:%22today+5-y%22%7D%5D,%22category%22:0,%22property%22:%22%22%7D&tz=-120";
...
//    }
   ...
   /* for (String data : valueAndTime) {
    ...
    File file = new File("C:/demo/DollarTreeUS.xls");
