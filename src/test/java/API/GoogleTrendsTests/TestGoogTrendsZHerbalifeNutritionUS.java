...
public class TestGoogTrendsZHerbalifeNutritionUS {
  String token = null;
...
//    cellStyle5.setDataFormat(wb.createDataFormat().getFormat("0.00%"));
   ...
   /* for (String data : valueAndTime) {
    ...
    // EmpNo
    cell = row.createCell(115, CellType.STRING);
    cell.setCellValue("HerbalifeNutritionUS");
...
//      }
    ...
    for (String data : valueAndTime) {
      ...
      cell = rowValue.createCell(115, CellType.NUMERIC);
      //cell.setCellValue(data);
