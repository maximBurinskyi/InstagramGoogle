...
public class TestGoogTrendsZHomeDepotUS {
  String token = null;
  ...
  public void apiTest1() throws UnirestException, FileNotFoundException {
    ...
    String postApi = "https://trends.google.com/trends/api/explore?hl=en-US&tz=-180&req=%7B%22comparisonItem%22:%5B%7B%22keyword%22:%22%2Fm%2F01zj1t%22,%22geo%22:%22US%22,%22time%22:%22today+5-y%22%7D%5D,%22category%22:0,%22property%22:%22%22%7D&tz=-180";
...
//    cellStyle5.setDataFormat(wb.createDataFormat().getFormat("0.00%"));
   ...
   /* for (String data : valueAndTime) {
    ...
    // EmpNo
    cell = row.createCell(117, CellType.STRING);
    cell.setCellValue("HomdeDepotUS");
...
//      }
    ...
    for (String data : valueAndTime) {
      ...
      cell = rowValue.createCell(117, CellType.NUMERIC);
      //cell.setCellValue(data);
