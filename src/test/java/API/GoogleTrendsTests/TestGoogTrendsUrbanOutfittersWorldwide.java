...
public class TestGoogTrendsUrbanOutfittersWorldwide {
  String token = null;
...
//    cellStyle5.setDataFormat(wb.createDataFormat().getFormat("0.00%"));
   ...
   /* for (String data : valueAndTime) {
    ...
    // EmpNo
    cell = row.createCell(104, CellType.STRING);
    cell.setCellValue("UrbanOutfittersWorldwide");
...
//      }
    ...
    for (String data : valueAndTime) {
      ...
      cell = rowValue.createCell(104, CellType.NUMERIC);
      //cell.setCellValue(data);
