...
public class TestGoogTrendsVicrotoriaSecretUS {
  String token = null;
...
//    cellStyle5.setDataFormat(wb.createDataFormat().getFormat("0.00%"));
   ...
   /* for (String data : valueAndTime) {
    ...
    // EmpNo
    cell = row.createCell(107, CellType.STRING);
    cell.setCellValue("VictoriaSecretUS");
...
//      }
    ...
    for (String data : valueAndTime) {
      ...
      cell = rowValue.createCell(107, CellType.NUMERIC);
      //cell.setCellValue(data);
