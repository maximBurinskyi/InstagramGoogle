...
public class TestGoogTrendsVictoriaSecretWorldwideExpediaUS {
  String token = null;
...
//    cellStyle5.setDataFormat(wb.createDataFormat().getFormat("0.00%"));
   ...
   /* for (String data : valueAndTime) {
    ...
    // EmpNo
    cell = row.createCell(109, CellType.STRING);
    cell.setCellValue("ExpdediaUS");
...
//      }
    ...
    for (String data : valueAndTime) {
      ...
      cell = rowValue.createCell(109, CellType.NUMERIC);
      //cell.setCellValue(data);
