...
public class TestGoogTrendsVansWorldwide {
  String token = null;
...
//    cellStyle5.setDataFormat(wb.createDataFormat().getFormat("0.00%"));
   ...
   /* for (String data : valueAndTime) {
    ...
    // EmpNo
    cell = row.createCell(106, CellType.STRING);
    cell.setCellValue("VansWorldwide");
...
//      }
    ...
    for (String data : valueAndTime) {
      ...
      cell = rowValue.createCell(106, CellType.NUMERIC);
      //cell.setCellValue(data);
