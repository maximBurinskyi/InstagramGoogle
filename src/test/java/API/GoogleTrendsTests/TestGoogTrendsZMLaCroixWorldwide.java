...
public class TestGoogTrendsZMLaCroixWorldwide {
  String token = null;
  ...
  public void apiTest1() throws UnirestException, FileNotFoundException {
    ...
    String postApi = "https://trends.google.com/trends/api/explore?hl=en-US&tz=-180&req=%7B%22comparisonItem%22:%5B%7B%22keyword%22:%22la+croix%22,%22geo%22:%22%22,%22time%22:%22today+5-y%22%7D%5D,%22category%22:0,%22property%22:%22%22%7D&tz=-180";
  ...
  public void apiTest2() throws UnirestException, IOException {
    ...
    String postApi = "https://trends.google.com/trends/api/widgetdata/multiline?hl=en-US&tz=-180&req=%7B%22time%22:%22"+time7+"%22,%22resolution%22:%22WEEK%22,%22locale%22:%22en-US%22,%22comparisonItem%22:%5B%7B%22geo%22:%7B%7D,%22complexKeywordsRestriction%22:%7B%22keyword%22:%5B%7B%22type%22:%22BROAD%22,%22value%22:%22la+croix%22%7D%5D%7D%7D%5D,%22requestOptions%22:%7B%22property%22:%22%22,%22backend%22:%22IZG%22,%22category%22:0%7D%7D&token="+token+"&tz=-180";
    String body = Unirest.get(postApi)
            // .routeParam("hl", "ru")
            //.header("tz", "-120")
...
//    cellStyle5.setDataFormat(wb.createDataFormat().getFormat("0.00%"));
   ...
   /* for (String data : valueAndTime) {
    ...
    // EmpNo
    cell = row.createCell(126, CellType.STRING);
    cell.setCellValue("LaCroixWorldwide");
...
//      }
    ...
    for (String data : valueAndTime) {
      ...
      cell = rowValue.createCell(126, CellType.NUMERIC);
      //cell.setCellValue(data);
