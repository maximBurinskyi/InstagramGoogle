...
public class GoogTrendsApiBase {
  ...
  public  String APITest1 (String url) throws UnirestException, MalformedURLException {
    //String postApi = "https://trends.google.com/trends/api/explore?hl=en-US&tz=-120&req=%7B%22comparisonItem%22:%5B%7B%22keyword%22:%22lululemon%22,%22geo%22:%22US%22,%22time%22:%22today+5-y%22%7D%5D,%22category%22:0,%22property%22:%22%22%7D&tz=-120";
    String postApi = url;
    ...
    for (Wi3 wi : request.widgets) {
      ...
      //System.out.println("time:" + wi.request.time);
      if (token == null) {
        for (int i = 0; i < 1; i++) {
          token = wi.token;
        }
    ...
    String query = url.substring(105, 118);
    System.out.println(query);

    URL url2 = new URL(url);
    StringBuilder sb = new StringBuilder();

    sb.append("host = " + url2.getHost() + " \n");
    sb.append("port = " + url2.getPort() + "\n");
    sb.append("query = " + url2.getQuery() + " \n");
