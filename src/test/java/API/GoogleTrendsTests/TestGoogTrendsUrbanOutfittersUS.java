...
public class TestGoogTrendsUrbanOutfittersUS {
  String token = null;
...
//    cellStyle5.setDataFormat(wb.createDataFormat().getFormat("0.00%"));
   ...
   /* for (String data : valueAndTime) {
    ...
    // EmpNo
    cell = row.createCell(103, CellType.STRING);
    cell.setCellValue("UrbanOutfittersUS");
...
//      }
    ...
    for (String data : valueAndTime) {
      ...
      cell = rowValue.createCell(103, CellType.NUMERIC);
      //cell.setCellValue(data);
