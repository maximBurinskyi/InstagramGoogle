...
public class TestGoogTrendsVictoriaSecretWorldwide {
  String token = null;
...
//    cellStyle5.setDataFormat(wb.createDataFormat().getFormat("0.00%"));
   ...
   /* for (String data : valueAndTime) {
    ...
    // EmpNo
    cell = row.createCell(108, CellType.STRING);
    cell.setCellValue("VictoriaSecretWorldwide");
...
//      }
    ...
    for (String data : valueAndTime) {
      ...
      cell = rowValue.createCell(108, CellType.NUMERIC);
      //cell.setCellValue(data);
