...
public class TestGoogTrendsZFiveBelowWorldwide {
  String token = null;
...
//    cellStyle5.setDataFormat(wb.createDataFormat().getFormat("0.00%"));
   ...
   /* for (String data : valueAndTime) {
    ...
    // EmpNo
    cell = row.createCell(112, CellType.STRING);
    cell.setCellValue("FiveBelowWorldwide");
...
//      }
    ...
    for (String data : valueAndTime) {
      ...
      cell = rowValue.createCell(112, CellType.NUMERIC);
      //cell.setCellValue(data);
